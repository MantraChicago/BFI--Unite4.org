class Badge < ActiveRecord::Base
  ...
  DefaultBadges = [
      ...
      {name: 'Cinema Buff', slug: 'cinema_buff', file_name: 'cinema_buff.png',description_after: 'You watched 5 videos', description_before: "Become a true cinema buff by watching more cause videos. Here's a few recommendations for your playlist.",category: 'Learning', badge_type: 'Repeat_able', sub_text: 'Keep on checking out those videos'},
      {name: 'Enthusiast', slug: 'enthusiast', file_name: 'enthusiast.png',description_after: 'You followed at least 5 causes', description_before: "There are so many causes, and it can be hard to remember which ones you've visited...unless you're following them, that is!" ,category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Doler of Dollars', slug: 'doler_of_dollars', file_name: 'doler_of_dollars.png',description_after: 'You followed at least 5 causes', description_before: "Supporting causes financially allows them to support the community with goods and services.",category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Megaphone', slug: 'megaphone', file_name: 'megaphone.png',description_after: 'You shared multiple messages', description_before: "It's time to start chatting up your favorite causes - the more people who know about causes, the more help they see. Think about sharing these causes that you've visited with your friends.",category: 'sharing', badge_type: 'repeat_able', sub_text: 'Tell your friends!'},  
