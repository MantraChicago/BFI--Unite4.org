class Badge < ActiveRecord::Base
  ...
  attr_accessible :name, :description, :file_name, :accomplishment, :description_after, :description_before, :category, :badge_type, :sub_text
  ...
  DefaultBadges = [
      ...
      {name: 'Chatty Cathy', file_name: 'chatty_cathy.png',description_after: "You chatted up an awesome cause to your friends.", description_before: "Earn this badge by sharing causes through the social media/email links on each cause page. Letting more people know what they can do to help is awesome! Need some ideas of causes to share?",category: 'Sharing', badge_type: 'one_time', sub_text: 'Tell your friends about your new favorite cause'},
      ...
      {name: 'Cinema Buff', file_name: 'cinema_buff.png',description_after: '', description_before: "Become a true cinema buff by watching more cause videos. Here's a few recommendations for your playlist.",category: 'Learning', badge_type: 'Repeat_able', sub_text: 'Keep on checking out those videos'},
      {name: 'Enthusiast', file_name: 'enthusiast.png',description_after: '', description_before: "There are so many causes, and it can be hard to remember which ones you've visited...unless you're following them, that is!" ,category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Doler of Dollars', file_name: 'doler_of_dollars.png',description_after: '', description_before: "Supporting causes financially allows them to support the community with goods and services.",category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Megaphone', file_name: 'megaphone.png',description_after: '', description_before: "It's time to start chatting up your favorite causes - the more people who know about causes, the more help they see. Think about sharing these causes that you've visited with your friends.",category: 'sharing', badge_type: 'repeat_able', sub_text: 'Tell your friends!'},  
      ...
      {name: "We're Not So Far Away", file_name: 'were_not_so_far_away.png',description_after: "You earned this special badge by visiting 5 global outreach causes.", description_before: "Each and every day, the world gets a little bit smaller, thanks to you and your interest in global outreach.",category: 'learning', badge_type: 'theme', sub_text: 'Learn about 5 global outreach causes'},
      ...
      {name: 'Apple A Day', file_name: 'apple_a_day.png',description_after: 'Learn about 5 Health and Wellness causes.', description_before: "You're tossing apples left and right, supporting health and wellness for everybody.",category: 'learning', badge_type: 'theme', sub_text: 'Learn about 5 Health and Wellness causes'},   
      ...
      {name: 'Sample Platter', file_name: 'sample_platter.png',description_after: 'You earned this special badge by visiting causes from each theme.', description_before: 'Look at you, learning a little bit about everything.',category: 'learning', badge_type: 'theme', sub_text: 'Well-rounded supporter, learning about all subjects!'},  
