class Badge < ActiveRecord::Base
  ...
  attr_accessible :name, :slug, :description, :file_name, :accomplishment, :description_after, :description_before, :category, :badge_type, :sub_text
  ...
  DefaultBadges = [
      ...
      {name: 'Getting Out There', slug: 'getting_out_there', file_name: 'getting_out_there.png',description_after: "You let #CAUSE know that you were ready to get out there and help them out.", description_before: "Got the will but not the way? Pick a cause from below and let them know that you're ready to volunteer!",category: 'Giving', badge_type: 'one_time', sub_text: 'Let a cause know you want to help them'},
      {name: 'Cinema Buff', slug: 'cinema_buff', file_name: 'cinema_buff.png',description_after: '', description_before: "Become a true cinema buff by watching more cause videos. Here's a few recommendations for your playlist.",category: 'Learning', badge_type: 'Repeat_able', sub_text: 'Keep on checking out those videos'},
      {name: 'Enthusiast', slug: 'enthusiast', file_name: 'enthusiast.png',description_after: '', description_before: "There are so many causes, and it can be hard to remember which ones you've visited...unless you're following them, that is!" ,category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Doler of Dollars', slug: 'doler_of_dollars', file_name: 'doler_of_dollars.png',description_after: '', description_before: "Supporting causes financially allows them to support the community with goods and services.",category: 'giving', badge_type: 'repeat_able', sub_text: 'Spread your wealth around!'},
      {name: 'Megaphone', slug: 'megaphone', file_name: 'megaphone.png',description_after: '', description_before: "It's time to start chatting up your favorite causes - the more people who know about causes, the more help they see. Think about sharing these causes that you've visited with your friends.",category: 'sharing', badge_type: 'repeat_able', sub_text: 'Tell your friends!'},  
      {name: 'Dirt Under Your Fingernails', slug: 'dirt_under_your_fingernails', file_name: 'dirt_under_your_fingernails.png',description_after: '', description_before: "Volunteering can be dirty work sometimes, but it's also really rewarding. Here are a few causes that you have followed or visited that really need a little extra person power - let them know that you can do it!",category: 'giving', badge_type: 'repeat_able', sub_text: 'Let 5 causes know how you can help them out'},
