class Badge < ActiveRecord::Base
  ...
  DefaultBadges = [
      ...
      {is_active: true, name: 'Megaphone', slug: 'megaphone', file_name: 'megaphone.png',description_after: 'You shared multiple messages', description_before: "It's time to start chatting up your favorite causes - the more people who know about causes, the more help they see. Think about sharing these causes that you've visited with your friends.",category: 'sharing', badge_type: 'repeat_able', sub_text: 'Tell your friends!'},  
